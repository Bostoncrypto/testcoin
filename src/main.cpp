...
uint256 hashGenesisBlock("0xb723793cef58bba25e46c2aecf61da1f7f14df80a4dcafc71c21a20592f6820d");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb723793cef58bba25e46c2aecf61da1f7f14df80a4dcafc71c21a20592f6820d");  //new genesis block here
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1317972665;  //google lastest epoch time
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 246683;  //put new nonce here

        if (fTestNet)
        {
            block.nTime    = 1317798646;  //and again
            block.nNonce   = 246683;  //and again 
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));  //delete code below after genesis block made
